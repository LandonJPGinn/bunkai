    ...
    test('duplicate japanese (after normalization)', () {
      final quiz = _minimalQuiz([
        ...
        _q(
          ...
          choices: const [
            AnswerChoice(id: 'a', label: 'u'),
            AnswerChoice(id: 'b', label: 'v'),
          ],
          correctAnswerId: 'b',
        ),
      ]);
    ...
    test('duplicate prompt', () {
      final quiz = _minimalQuiz([
        ...
        _q(
          ...
          japanese: 'j2',
          choices: const [
            AnswerChoice(id: 'a', label: 'p'),
            AnswerChoice(id: 'b', label: 'q'),
          ],
          correctAnswerId: 'a',
        ),
      ]);
    ...
    test('repeated answer choice set (order-independent)', () {
      final quiz = _minimalQuiz([
        _q(
          ...
          japanese: 'j1',
          choices: const [
            AnswerChoice(id: 'w', label: 'は'),
            AnswerChoice(id: 'x', label: 'が'),
            AnswerChoice(id: 'y', label: 'を'),
          ],
          correctAnswerId: 'w',
        ),
        _q(
          ...
          japanese: 'j2',
          choices: const [
            AnswerChoice(id: 'a', label: 'を'),
            AnswerChoice(id: 'b', label: 'は'),
            AnswerChoice(id: 'c', label: 'が'),
          ],
          correctAnswerId: 'a',
        ),
      ]);
